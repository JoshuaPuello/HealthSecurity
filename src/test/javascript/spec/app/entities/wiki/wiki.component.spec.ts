...
import { WikiComponent } from 'app/entities/wiki/wiki.component';
import { WikiService } from 'app/entities/wiki/wiki.service';
import { Wiki } from 'app/shared/model/wiki.model';

describe('Component Tests', () => {
    describe('Wiki Management Component', () => {
        let comp: WikiComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(WikiComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.wikis[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
