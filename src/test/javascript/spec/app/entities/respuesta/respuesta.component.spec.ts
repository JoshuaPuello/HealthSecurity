...
import { RespuestaComponent } from 'app/entities/respuesta/respuesta.component';
...
describe('Component Tests', () => {
    describe('Respuesta Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.respuestas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
