...
describe('Service Tests', () => {
    describe('Respuesta Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(RespuestaService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/respuestas';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Respuesta', () => {
                service.create(new Respuesta(null)).subscribe(received => {
            ...
            it('should update a Respuesta', () => {
                service.update(new Respuesta(123)).subscribe(received => {
