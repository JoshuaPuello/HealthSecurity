    ...
    describe('Reporte Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/reportes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Reporte', () => {
                service.create(new Reporte(null)).subscribe(received => {
            ...
            it('should update a Reporte', () => {
                service.update(new Reporte(123)).subscribe(received => {
