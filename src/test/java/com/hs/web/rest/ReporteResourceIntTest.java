...
public class ReporteResourceIntTest {
    ...
    private static final String DEFAULT_ACCIONES_REALIZADAS = "AAAAAAAAAA";
    private static final String UPDATED_ACCIONES_REALIZADAS = "BBBBBBBBBB";
    ...
    public static Reporte createEntity(EntityManager em) {
        Reporte reporte = new Reporte()
            ...
            .acciones_realizadas(DEFAULT_ACCIONES_REALIZADAS)
    ...
    public void createReporte() throws Exception {
        ...
        assertThat(testReporte.getAcciones_realizadas()).isEqualTo(DEFAULT_ACCIONES_REALIZADAS);
    ...
    public void getAllReportes() throws Exception {
        ...
        restReporteMockMvc.perform(get("/api/reportes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].acciones_realizadas").value(hasItem(DEFAULT_ACCIONES_REALIZADAS.toString())))
    ...
    public void getReporte() throws Exception {
        ...
        restReporteMockMvc.perform(get("/api/reportes/{id}", reporte.getId()))
            ...
            .andExpect(jsonPath("$.acciones_realizadas").value(DEFAULT_ACCIONES_REALIZADAS.toString()))
    ...
    public void updateReporte() throws Exception {
        ...
        updatedReporte
            ...
            .acciones_realizadas(UPDATED_ACCIONES_REALIZADAS)
        ...
        assertThat(testReporte.getAcciones_realizadas()).isEqualTo(UPDATED_ACCIONES_REALIZADAS);
