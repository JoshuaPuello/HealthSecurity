...
public class Categoria implements Serializable {
    ...
    public Categoria wikis(Set<Wiki> wikis) {
        this.wikis = wikis;
        return this;
    }

    public Categoria addWiki(Wiki wiki) {
        this.wikis.add(wiki);
        wiki.setCategoria(this);
        return this;
    }

    public Categoria removeWiki(Wiki wiki) {
        this.wikis.remove(wiki);
        wiki.setCategoria(null);
        return this;
    }
