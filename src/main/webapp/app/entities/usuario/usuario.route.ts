...
export class UsuarioResolve implements Resolve<IUsuario> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot) {
        ...
        if (id) {
            return this.service.find(id).map((usuario: HttpResponse<Usuario>) => usuario.body);
        }
        return Observable.of(new Usuario());
    }
}
...
export const usuarioRoute: Routes = [
    {
        ...
        data: {
            ...
            defaultSort: 'id,asc',
            pageTitle: 'healthSecurityApp.usuario.home.title'
        },
