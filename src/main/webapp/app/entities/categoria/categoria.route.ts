...
export class CategoriaResolve implements Resolve<ICategoria> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot) {
        ...
        if (id) {
            return this.service.find(id).map((categoria: HttpResponse<Categoria>) => categoria.body);
        }
        return Observable.of(new Categoria());
    }
}
...
export const categoriaRoute: Routes = [
    {
        ...
        data: {
            ...
            defaultSort: 'id,asc',
            pageTitle: 'healthSecurityWebApp.categoria.home.title'
        },
